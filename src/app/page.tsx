...
export default function Home() {
    ...
    const [googleDetails, setGoogleDetails] = useState<GoogleDetails | null>(
        null
    );
        ...
        const fetchFullGoogleDetails = async () => {
            ...
            try {
                const response = await fetch(
                    `/api/details?name=${encodeURIComponent(
                        recommendation.place_name
                    )}&lat=${recommendation.y}&lng=${recommendation.x}`
                );
                if (response.ok) {
                                    ...
                                    <div className="py-4 space-y-4">
                                        ...
                                        <div>
                                            <Label
                                                ...
                                                className="text-lg font-semibold"
                                            >
                                                검색 개수: {tempResultCount}개
                                            </Label>
                                            <Slider
                                                id="temp-result-count"
                                                value={[tempResultCount]}
                                                onValueChange={(value) =>
                                                    setTempResultCount(value[0])
                                                }
                                                min={5}
                                                max={15}
                                                step={1}
                                                ...
                                                {place.googleDetails
                                                    ...
                                                    <div className="flex items-center">
                                                        ...
                                                        <span className="text-xs font-semibold">
                                                            {place.googleDetails.rating.toFixed(
                                                                1
                                                            )}
                                                        </span>
                                                    </div>
                    ...
                    <DialogContent className="sm:max-w-[425px]">
                        ...
                        <div className="py-4 text-sm space-y-2">
                            <p>
                                ...
                                <span className="ml-2">Kakao Maps API</span>
                            </p>
                            <p>
                                <strong className="font-semibold">
                                    ⭐ 별점 및 상세 정보:
                                </strong>
                                <span className="ml-2">Google Maps API</span>
                            </p>
                        </div>
                    </DialogContent>
                </Dialog>
                ...
                <DialogContent className="max-w-md p-6">
                    ...
                    <div className="flex flex-col justify-center items-center space-y-6">
                        ...
                        <Button
                            ...
                            disabled={mustSpin}
                            className="w-full max-w-[isRouletteOpen, setIsRouletteOpen]0px]"
                        >
                            돌리기
                        </Button>
                    </div>
