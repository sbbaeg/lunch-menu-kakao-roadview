...
export async function DELETE(request: Request, { params }: { params: { id: string } }) {
    ...
    try {
        // First, check if the tag is associated with any restaurants.
        // Depending on business logic, you might want to prevent deletion if it's widely used,
        // but for now, we will proceed with deletion.
        
        // Prisma automatically handles cascading deletes for relation tables (TagReview, TagSubscription).
